...
class TestViews(TestCase):
    ...
    def test_user_agrees_multiple_times(self):
        ...
        self.assertEqual(
            UserAgreement.objects.filter(user=self.user2).count(),
            1
        )
    ...
    def test_need_agreement(self):
        ...
        response = self.client.post(
            self.login_url,
            dict(username='user2', password='user2pass')
        )
    ...
    def test_do_not_need_agreement(self):
        ...
        response = self.client.post(
            self.login_url,
            dict(username='user1', password='user1pass')
        )
    ...
    def test_root_tos_view(self):
        ...
        self.assertIn(
            b'first edition of the terms of service',
            response.content
        )
